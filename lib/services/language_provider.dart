  ...
  String translate(String key) {
    ...
    final translations = {
      'en': {
        ...
        'verbs': 'Verbs',
        'examen': 'Examen',
        'examen_desc': 'B1 Final Evaluation',
        'essays': 'Essays',
        'dialogues': 'Dialogues',
      ...
      'fr': {
        ...
        'verbs': 'Verbes',
        'examen': 'Examen',
        'examen_desc': 'Évaluation finale B1',
        'essays': 'Rédactions',
        'dialogues': 'Dialogues',
      ...
      'ar': {
        ...
        'verbs': 'الأفعال',
        'examen': 'امتحان',
        'examen_desc': 'التقييم النهائي B1',
        'essays': 'مقالات',
        'dialogues': 'حوارات',
      ...
      'uk': {
        ...
        'verbs': 'Дієслова',
        'examen': 'Іспит',
        'examen_desc': 'Підсумковий іспит B1',
        'essays': 'Твори',
        'dialogues': 'Діалоги',
      ...
      'it': {
        ...
        'verbs': 'Verbi',
        'examen': 'Esame',
        'examen_desc': 'Valutazione finale B1',
        'essays': 'Saggi',
        'dialogues': 'Dialoghi',
      ...
      'tr': {
        ...
        'verbs': 'Fiiller',
        'examen': 'Sınav',
        'examen_desc': 'B1 Final Değerlendirmesi',
