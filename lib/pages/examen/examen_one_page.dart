...
class _ExamenOnePageState extends State<ExamenOnePage> {
  ...
  Widget _buildIntroSection() {
    return SingleChildScrollView(padding: const EdgeInsets.all(24), child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
      ...
      _iBullet('Grammaire : 10 QCM (Conditionnel, Voix Passive, COD/COI, Impératif, Comparatif/Superlatif)'),
      ...
      const SizedBox(height: 8),
      _iSub('Grammaire :', 'Conditionnel, Voix Passive, COD/COI, L\'Impératif, et Comparatifs/Superlatifs.'),
      const SizedBox(height: 8),
